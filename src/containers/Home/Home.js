            ...
            <div className={styles.home}>
                ...
                <div className={styles.masthead}>
                    <div className="container">
                        ...
                        <p>
                            <a className={styles.github} href="https://github.com/21echoes/my-react-starter-kit"
                                target="_blank">
                        ...
                        <p className={styles.humility}>
                            Created and maintained by <a href="https://twitter.com/21echoes" target="_blank">@21echoes</a>.
                        </p>
                    </div>
                </div>
                ...
                <div className="container">
                    ...
                    <ul>
                        ...
                        <li><a href="https://github.com/brianc/node-postgres" target="_blank">Node Postgres</a> for Postgres integration</li>
                        <li><a href="https://github.com/theoephraim/node-pg-migrate" target="_blank">Node PG-Migrate</a> for Postgres migration</li>
                        <li><a href="https://github.com/tj/connect-redis" target="_blank">Connect Redis</a> for Redis-based sessions</li>
                        <li><a href="https://github.com/21echoes/jsonapi-server.git" target="_blank">JSON:API Server</a> and Cartographer-JS (not yet separated into a package) for dead-simple well-designed APIs</li>
                        <li><a href="https://github.com/sstur/react-rte" target="_blank">React Rich Text Editor</a></li>
                        ...
                        <li><a href="http://webpack.github.io/docs/webpack-dev-middleware.html" target="_blank">Webpack Dev Middleware</a></li>
                        ...
                        <li>
                            <a href="https://github.com/erikras/multireducer" target="_blank">multireducer</a>
                    ...
                    <dl>
                        ...
                        <dd>
                            ...
                            function is called before the widgets page is loaded, on either the server
